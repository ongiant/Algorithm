...
public class Main {
    ...
    static RedBlackBST<String, Integer> redBlackTree;
    ...
    public static void main(String[] args) throws IOException{
        String filePath = "../../Downloads/GoneWithTheWind.txt";
...
//                    else if(c == '-'){ // 处理self-reliance这种单词
//
//                    }
                    else{
                        insertToRedBlackTree();
                    }
                }
                insertToRedBlackTree();
            }
            ...
            Iterator<String> reverseIterator = wordList.descendingIterator();
            while(reverseIterator.hasNext()){
                String s = reverseIterator.next();
    ...
    static void insertToRedBlackTree(){
        redBlackTree.put(sbuilder.toString(), 1);
        init();
    }
}
